...
namespace Clusterizer
{
    static class Tools
    {
        ...
        public static int HeadingsCount => Headings.Length;
        public static int DataPointStartIndex = 6;

        public static bool[] isDataPoint;

        public static string[] GetChosenDataPointNames(bool[] isChosen)
        {
            List<string> tmpList = new List<string>();
            for (int i = 0; i < isChosen.Length; i++)
                if (isChosen[i])
                    tmpList.Add(DataPointsNames[i]);
            return tmpList.ToArray();
        }

        public static string[] GroupNames = new string[]
        {
        ...
        public static int GroupCount => GroupNames.Length;

        public static int[] GroupItemsCount = new int[]
        {
            15,
            16,
            13,
        ...
        public static string[] AdditionalDataNames;
        public static string[] DataPointsNames;
        public static int DataPointCount => DataPointsNames.Length;
        public static string[][] GroupItemsNames;
        public static int[][] GroupItemsIndexes;

        static Tools()
        {
            isDataPoint = new bool[HeadingsCount];
            List<string> tmpList = new List<string>();
            List<string> names = new List<string>();
            for (int i = 0; i < HeadingsCount; i++)
            {
                isDataPoint[i] = (i >= DataPointStartIndex);
                if (i >= DataPointStartIndex)
                {
                    isDataPoint[i] = true;
                    tmpList.Add(Headings[i]);
                }
                else
                {
                    isDataPoint[i] = false;
                    names.Add(Headings[i]);
                }
            }

            DataPointsNames = tmpList.ToArray();
            AdditionalDataNames = names.ToArray();
